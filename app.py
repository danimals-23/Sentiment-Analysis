...
def create_gaussian_naive_bayes() -> GaussianNB:
...
#     fpath = "C:\\Users\\pengx\\Desktop\\CS135\\hw5\\movie-reviews.csv"
#     X_train, X_test, y_train, y_test = split_data(fpath)
...
data = load_data("C:\\Users\\pengx\\Desktop\\CS135\\hw5\\movie-reviews.csv")
clf = create_naive_bayes_classifier()
vectorizer = train_classifier(clf, data['review'].values, data['sentiment'].values)
...
def classify_sentence(sentence):
    sentiment = test_classifier(clf, vectorizer, [sentence])
    return sentiment[0]
